...
public class VisibilityXYDegree1 {
    ...
    public VisibilityXYDegree1(List<XYData> InputTimeSeries, int PSVGRequiredStart, double PSVGDataPartFromStart,
    ...
    public void printPSVGListToConsole() {
        ...
        Logger.getLogger(VisibilityXYDegree1.class.getName()).log(Level.INFO,"k P(k) log(p(k)) log(1/k)" );
        for (int i = 0; i < PSVGList.size(); i++) {
            PSVGDet = PSVGList.get(i);
            Logger.getLogger(VisibilityXYDegree1.class.getName()).log(Level.INFO, "{0} {1} {2} {3}", new Object[]{PSVGDet.getDegValue(), PSVGDet.getProbOfDegVal(), PSVGDet.getlogOfProbOfDegVal(), PSVGDet.getLogOfDegVal()});
        }
        Logger.getLogger(VisibilityXYDegree1.class.getName()).log(Level.INFO, "PSVG{0}x + {1}", new Object[]{PSVGFractalDimension, PSVGIntercept});
    }
    ...
    public void calcPSVGChiSquareVal() {
        ...
        if (listSize < 3) {
            Logger.getLogger(VisibilityXYDegree1.class.getName()).log(Level.SEVERE,"Chi square could not be calculated" );
